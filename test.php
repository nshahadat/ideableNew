    ...
    <form action="#" method="post">
        <div class="feed-container">
            <section class="feed-left">
                <h1 class="userheader">
                    <?php echo $post_fetch_username; ?> has an idea of <?php echo $post_fetch_title; ?>
                </h1>
            ...
            button is clicked -->
                ...
                <p>Theoratically Proved: <?php echo $post_fetch_tp; ?>; Practically Proved: <?php echo $post_fetch_pp; ?>;
                    Demo: <?php echo $post_fetch_demo; ?>; Business Model: <?php echo $post_fetch_bm; ?>; Patent: <?php echo $post_fetch_patent; ?>; Approximate Time: <?php echo $post_fetch_at; ?></p>
...
?>                let scHeight = e.target.scrollHeight;
                ...
                <button class="ask-btn" name="ask-btn">ask</button>
    </form>

...
<div class="banner-text-1">
    <p style="font-family: 'Inter', sans-serif;font-size: 2vw;">Even the simplest idea can give you the greatest success</p>
</div>
    <div class="info-part" style="padding-bottom: 40px; font-size:3vw; width:100vw !important; padding-top:300px;">ideas that got investment</div>
...
<div class="gal-container">
            ...
            <div class="gallery">
                ...
                <p class="gallery-desc">Pinnipeds, commonly known as seals,[a] are a widely distributed and diverse clade of carnivorous, fin-footed, semiaquatic marine mammals. They comprise the extant families Odobenidae (whose only living member is the walrus), Otariidae (the eared seals: sea lions and fur seals), and Phocidae (the earless seals, or true seals).</p>
            </div>
            <div class="gallery">
                ...
                <p class="gallery-desc">The lion (Panthera leo) is a species in the family Felidae and a member of the genus Panthera. It has a muscular, deep-chested body, short, rounded head, round ears, and a hairy tuft at the end of its tail. It is sexually dimorphic; adult male lions have a prominent mane.</p>
            </div>
            <div class="gallery">
                ...
                <p class="gallery-desc">Hawks are a group of medium-sized diurnal birds of prey of the family Accipitridae. Hawks are widely distributed and vary greatly in size.

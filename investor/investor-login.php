    ...
    <div class="signin-signup">
      <form action="" method="post" class="sign-in-form">
        ...
        <div class="input-field">
          ...
          <input type="password" placeholder="Password" name="u_signin_pass"
            value="<?php echo $_POST['u_signin_pass']; ?>" required />
        </div>
        ...
        <p style="display: flex;justify-content: center;align-items: center;margin-top: 20px;"><a
            href="forget-pass-investor.php" style="color: #4590ef;">Forgot Password?</a></p>
      </form>
      <form action="" class="sign-up-form" method="post">
        <h2 class="title"> investor Sign up</h2>
        <div class="input-field">
          <i class="fas fa-user"></i>
          <input type="text" placeholder="Full Name" name="u_signup_name" value="<?php echo $_POST["u_signup_name"]; ?>"
            required />
        </div>
        <div class="input-field">
          <i class="fas fa-envelope"></i>
          <input type="email" placeholder="Email Address" name="u_signup_email"
            value="<?php echo $_POST["u_signup_email"]; ?>" required />
        </div>
        <div class="input-field">
          <i class="fas fa-lock"></i>
          <input type="password" placeholder="Password" name="u_signup_password"
            value="<?php echo $_POST["u_signup_password"]; ?>" required />
        </div>
        <div class="input-field">
          <i class="fas fa-lock"></i>
          <input type="password" placeholder="Confirm Password" name="u_signup_cpassword"
